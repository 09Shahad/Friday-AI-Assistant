...
def ask_ai(prompt):
    try:
        ...
        user_age = memory.get("age", "Unknown")
        user_city = memory.get("city", "Unknown")
        user_hobby = memory.get("hobby", "Unknown")

        system_instruction = (
            f"You are Friday, a smart and friendly AI assistant. "
            f"The user's name is {user_name}, aged {user_age}, living in {user_city}, "
            f"and their hobby is {user_hobby}."
        )
